  ...
  def receiverDomainString(): String = {
    ...
    val receiverOut =
      s"""domain $recDKey[$compDTV0] {
         ...
         |    function invers$recEvalKey(r:$recDKey[$compDTV0], r:Ref) : $compDTV0
  ...
  def compDomainString(): String = {
    ...
    val compOut =
      s"""domain $compDKey[$compDTV0,$compDTV1,$compDTV2] {
         |    function $compFKey(r:$recDKey[$compDTV0], m: Mapping[$compDTV1,$compDTV2],
         |        op: $opDKey[$compDTV2],u: $compDTV2) : $compDKey[$compDTV0,$compDTV1,$compDTV2]
         |    function evalComp(c: $compDKey[$compDTV0,$compDTV1,$compDTV2],
